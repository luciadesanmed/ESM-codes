...
cases = ('pr_bias_EC-Earth3-EC-Earth3-AerChem.nc', 'pr_bias_EC-Earth3-EC-Earth3-Veg-LR.nc', 'pr_bias_EC-Earth3-AerChem-EC-Earth3-Veg-LR.nc',
         'tas_bias_EC-Earth3-EC-Earth3-AerChem.nc', 'tas_bias_EC-Earth3-EC-Earth3-Veg-LR.nc',
         'tas_bias_EC-Earth3-AerChem-EC-Earth3-Veg-LR.nc', 'hurs_bias_EC-Earth3-EC-Earth3-AerChem.nc',
         'hurs_bias_EC-Earth3-EC-Earth3-Veg-LR.nc', 'hurs_bias_EC-Earth3-AerChem-EC-Earth3-Veg-LR.nc')

variab = ('pr', 'tas', 'hurs')
cmaps = ('RdBu','RdBu','RdBu') #_r to invert the colormap
nlevels1 = (200, 200, 200) 
vmin1 = (-2, -3, -5)
vmax1 = (2.1, 3.1, 5.1)
cticks = (0.4, 0.5, 1)
units = ('mm/day', '°C', '%')
cbarext = ('both','both','both')
exps = ('(EC-Earth3)-(EC-Earth3-AerChem):', '(EC-Earth3)-(EC-Earth3-Veg-LR):', '(EC-Earth3-AerChem)-(EC-Earth3-Veg-LR):')
...
for i in cases:
    ...
    # Labels and title
    ax.set_title('BIAS '+ exps[n2] +' '+ texts[n1], fontsize=20, fontweight='bold')

   # plt.show()
    plt.savefig("bias_ECEARTH_"+str(nn)+".png")
