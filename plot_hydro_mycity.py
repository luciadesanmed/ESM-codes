...
ax1.plot(mth, -1000*var[2],
         color='r',
         linestyle='--')
ax1.set_xlabel("Month", fontsize=fz, fontweight='bold')
ax1.set_ylabel(r" mm day$^{-1}$", fontsize=fz, fontweight='bold')
#plt.yticks(np.arange(-50,300.1,50))
ax1.set_xticks(np.arange(1, 12.1, 1), labels=['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'], fontsize=fz)
#plt.ylim(-49, 300)
